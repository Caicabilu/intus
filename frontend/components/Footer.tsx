...
export default function Footer() {
  ...
  return (
    <footer className="bg-intus-dark text-white">
      {/* Main Footer */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center text-gray-300">
                <svg className="w-5 h-5 mr-3 text-intus-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:contacto@intus.com" className="hover:text-intus-gold transition-colors">
                  contacto@intus.com
                </a>
              </div>
              <div className="flex items-center text-gray-300">
                ...
                <a href="https://wa.me/5491112345678" target="_blank" rel="noopener noreferrer" className="hover:text-intus-gold transition-colors">
                  WhatsApp
                </a>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/intus.tejidos" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-intus-gold transition-colors duration-200 p-2 hover:bg-white/5 rounded-lg">
              ...
              <a href="#" className="text-gray-400 hover:text-intus-gold transition-colors duration-200 p-2 hover:bg-white/5 rounded-lg">
          ...
          {/* Navigation */}
          <div>
            <h3 className="text-sm font-semibold text-intus-gold tracking-wider uppercase mb-4">
              Navegación
            </h3>
            <ul className="space-y-3">
              {navigation.main.map((item) => (
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className="text-gray-300 hover:text-intus-gold transition-colors duration-200"
                  >
                    {item.name}
                  </Link>
                </li>
